	...
	return (
		<>
			<header>
				...
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='theme-icon theme-icon-light'>
					...
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='theme-icon theme-icon-dark'>
